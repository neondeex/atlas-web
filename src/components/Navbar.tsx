      ...
      >
        ...
        <div className="flex items-center gap-4 text-sm font-medium">
          <Link 
            ...
            onClick={() => posthog?.capture("community_clicked", { platform: "discord", source: "navbar" })} 
            target="_blank" 
          ...
          <button 
            onClick={() => { posthog?.capture('pre_order_clicked', { source: 'navbar' }); window.dispatchEvent(new CustomEvent('open-early-beta')); }}
            className={cn(
